...
ToggleButton::ToggleButton(float _x, float _y, float _width, float _height, const sf::Font* _font, const std::string &_text_enabled, const std::string &_text_disabled, unsigned int _text_size, const ButtonColorSet& _color_enabled, const ButtonColorSet& _color_disabled, bool _is_enabled)
