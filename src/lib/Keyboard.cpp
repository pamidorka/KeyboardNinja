...
VirtualKeyboard::VirtualKeyboard(Settings* _settings)
{
...

    {
        ...
        buttons_[1].SetPosition(
                4 * (button_size_ + kSizeOfOutline_),
                2 * (button_size_ + kSizeOfOutline_));
        buttons_[2].SetPosition(
                2 * (button_size_ + kSizeOfOutline_),
                2 * (button_size_ + kSizeOfOutline_));
        buttons_[3].SetPosition(
                2 * (button_size_ + kSizeOfOutline_),
                button_size_ + kSizeOfOutline_);
        buttons_[4].SetPosition(2 * (button_size_ + kSizeOfOutline_), 0);
        buttons_[5].SetPosition(
                3 * (button_size_ + kSizeOfOutline_),
                button_size_ + kSizeOfOutline_);
        buttons_[6].SetPosition(
                4 * (button_size_ + kSizeOfOutline_),
                button_size_ + kSizeOfOutline_);
        buttons_[7].SetPosition(
                5 * (button_size_ + kSizeOfOutline_),
                button_size_ + kSizeOfOutline_);
        buttons_[8].SetPosition(7 * (button_size_ + kSizeOfOutline_), 0);
        buttons_[9].SetPosition(
                6 * (button_size_ + kSizeOfOutline_),
                button_size_ + kSizeOfOutline_);
        buttons_[10].SetPosition(
                7 * (button_size_ + kSizeOfOutline_),
                button_size_ + kSizeOfOutline_);
        buttons_[11].SetPosition(
                8 * (button_size_ + kSizeOfOutline_),
                button_size_ + kSizeOfOutline_);
        buttons_[12].SetPosition(
                6 * (button_size_ + kSizeOfOutline_),
                2 * (button_size_ + kSizeOfOutline_));
        buttons_[13].SetPosition(
                5 * (button_size_ + kSizeOfOutline_),
                2 * (button_size_ + kSizeOfOutline_));
        ...
        buttons_[26].SetSize(
                4 * (button_size_ + kSizeOfOutline_) - 1, button_size_);
        buttons_[27].SetCharacter("Shift");
        buttons_[27].SetSize(
                2 * (button_size_ + kSizeOfOutline_) - 1, button_size_);
...
{
    if ((_key < sf::Keyboard::A || _key > sf::Keyboard::Z)
        && _key != sf::Keyboard::Space && _key != sf::Keyboard::RShift
        && _key != sf::Keyboard::LShift) {
        return;
    }
...
void VirtualKeyboard::Draw(sf::RenderWindow* _window)
{
    for (int i = 0; i < kNumberOfButtons_; i++) {
        ...
        btn.setSize(
                sf::Vector2f(buttons_[i].GetSize().x, buttons_[i].GetSize().y));
        btn.setPosition(sf::Vector2f(
                position_.x + buttons_[i].GetPosition().x,
                position_.y + buttons_[i].GetPosition().y));
        ...
        text.setPosition(sf::Vector2f(
                position_.x + buttons_[i].GetPosition().x + 5,
                position_.y + buttons_[i].GetPosition().y + 3));
